...
# ---------- 유니버스: bots.state.universe로 분리(의존성 無 — logger 공용). 기존 임포트 호환 재수출 ----------
from bots.state.universe import (  # noqa: F401
    FX_SYMBOLS, CRYPTO_NAMESPACES, UNIVERSE_NAMESPACES, universe_of,
)
